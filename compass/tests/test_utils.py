...
from compass.utils import format_student_number, format_system_key, weekdays_before
...
class TestUtils(TestCase):
    ...
    def test_weekdays_before(self):
        ...
        # datetime
        val = weekdays_before(datetime(2024, 4, 19, 10, 30), offset_days=3)  # noqa: DTZ001
        self.assertEqual(str(val), '2024-04-16 10:30:00', 'Friday, offset=3')

        val = weekdays_before(datetime(2024, 4, 20, 0, 1), offset_days=3)  # noqa: DTZ001
        self.assertEqual(str(val), '2024-04-17 00:01:00', 'Saturday, offset=3')

        val = weekdays_before(datetime(2024, 4, 21, 23, 59), offset_days=3)  # noqa: DTZ001
        self.assertEqual(str(val), '2024-04-17 23:59:00', 'Sunday, offset=3')

        val = weekdays_before(datetime(2024, 4, 22), offset_days=1)  # noqa: DTZ001
        self.assertEqual(str(val), '2024-04-19 00:00:00', 'Monday, offset=1')

        val = weekdays_before(datetime(2024, 4, 22), offset_days=2)  # noqa: DTZ001
        self.assertEqual(str(val), '2024-04-18 00:00:00', 'Monday, offset=2')

        val = weekdays_before(datetime(2024, 4, 22), offset_days=3)  # noqa: DTZ001
        self.assertEqual(str(val), '2024-04-17 00:00:00', 'Monday, offset=3')

        # Bad offsets
        val = weekdays_before(datetime(2024, 4, 22), offset_days=None)  # noqa: DTZ001
        self.assertEqual(
            str(val), '2024-04-22 00:00:00', 'Monday, offset=None')

        val = weekdays_before(datetime(2024, 4, 22), offset_days=-5)  # noqa: DTZ001
        self.assertEqual(str(val), '2024-04-22 00:00:00', 'Monday, offset=-5')

        val = weekdays_before(datetime(2024, 4, 22), offset_days=0)  # noqa: DTZ001
